  ...
  return (
    <>
      ...
      <div className='h-64'> */}
       ...
       <button  className="rounded-lg w-full md:w-1/3 h-12 mb-4 mx-auto bg-gradient-to-tr from-rose-500 to-[#3D0C11]  text-white text-xl hover:scale-105 hover:shadow-md hover:shadow-red-800/60">Download Now</button>
     </a>
      </div>
