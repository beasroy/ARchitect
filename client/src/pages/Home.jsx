        ...
        <main className='w-full flex flex-col'>
           ...
           <Header title={
            <p>Build your Dream home with
             ...
             <section id="about-us" className='  rounded-xl bg-amber-100 md:max-w-[1440px]  mx-auto md:mx-20 px-4 my-20 pb-5  md:px-20 '>
              <div className='flex flex-col items-center justify-center mb-5'>
                ...
                <p className='px-4 font-montserrat font-light text-base text-orange-900 text-center'>Elevate your new home experience with ARchitect's 
              ...
              <div className='flex flex-row flex-wrap items-center justify-center mt-5 py-2 mb-5 gap-3'>
